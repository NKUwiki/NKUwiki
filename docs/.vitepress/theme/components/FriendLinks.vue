...
const links: FriendLink[] = [
	...
	{ name: 'NCEPUwiki', image: '/img/10/10/NCEPUwiki头像.png', url: 'https://wiki.ncepuinfo.cc/', description: '华北电力大学学生共同维护的非官方校园知识库。把散落的经验，整理成下一位同学用得上的指南。', tag: '兄弟院校' },
	...
	{ name: '西邮Wiki', image: '/img/10/10/西邮Wiki头像.png', url: 'https://wiki.cooo.site/', description: '《西邮 Wiki》是由校内智邮普创、Linux 兴趣小组、计科卓越、邮立方等多个校内实验室、非官方团体成员合作编写的校园生活指南，致力于为学生提供通透的校园见解，并将随着学校的发展持续更新。', tag: '兄弟院校' },
